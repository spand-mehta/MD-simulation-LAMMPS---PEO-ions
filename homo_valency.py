...
charge  = {1:0, 2:2, 3:-1}  # cation valency is +2

# define monomer
sequence = [1]*int(nbeads)

# files
INPUT_LAMMPS = open('input_homoions_0_1_angle_delta_Cu.lammps', 'w')

# constants
ntypes = 3 # PEO + anions + cations
ntot = npoly*nbeads
anion_diameter=1.0
cation_diameter=0.60
